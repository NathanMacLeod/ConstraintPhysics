...
namespace phyz {
	...
	public:
		...
		static Geometry bevelGear(mthz::Vec3 pos, double radius, double tooth_radius, double tooth_width, double tooth_height, double height, int n_teeth, bool parity = false, double density = 1.0);
