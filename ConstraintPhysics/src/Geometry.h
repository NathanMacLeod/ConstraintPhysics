...
namespace phyz {
	...
	public:
		...
		static Geometry bevelGear(mthz::Vec3 pos, double radius, double tooth_radius, double tooth_width, double tooth_height, double height, int n_teeth, bool parity = false, double density = 1.0, double hole_radius = 0.0, int circle_detail = 7);
		static Geometry pinion(mthz::Vec3 pos, double height, double width, double tooth_height, double tooth_width, double gap_width, int n_teeth, double density = 1.0);
