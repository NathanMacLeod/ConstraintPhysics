...
public:
	...
	void run() override {
		...
		double r = 50000;
		phyz::ConvexUnionGeometry sphere_ground = phyz::ConvexUnionGeometry::sphere(mthz::Vec3(0, -r, 0), r);
		bodies.push_back({ fromGeometry(sphere_ground), p.createRigidBody(sphere_ground, phyz::RigidBody::FIXED) });
