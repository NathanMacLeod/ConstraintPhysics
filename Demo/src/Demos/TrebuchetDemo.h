...
public:
	...
	void run() override {
		...
		phyz::ConvexUnionGeometry release_pin1 = phyz::ConvexUnionGeometry::cylinder(release_pin1_pos, release_pin_radius, release_pin_length, weight_material)
		...
		phyz::ConvexUnionGeometry release_pin2 = phyz::ConvexUnionGeometry::cylinder(release_pin2_pos, release_pin_radius, release_pin_length, weight_material)
