...
public:
	...
	void run() override {
		...
		bodies.push_back({ fromStaticMeshInput(marble_track_input, color{ 0.7f, 0.45f, 1.0f, 0.25f, 0.75f, 0.63f, 51.2f }), marble_track_r });

		phyz::RigidBody* marble_screw_r = p.createRigidBody(marble_screw_input, false);
		bodies.push_back({ fromStaticMeshInput(marble_screw_input, color{ 0.7f, 0.45f, 1.0f, 0.25f, 0.75f, 0.63f, 51.2f }), marble_screw_r });
