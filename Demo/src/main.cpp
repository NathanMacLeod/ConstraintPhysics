...
int main() {
	...
	manager.registerScene("Goblet", "Many objects in a static mesh goblet, being pushed by a kinematic object", [](DemoManager* m, DemoProperties p) { return new GobletDemo(m, p); });
